...
public class PaymentController(PaymentServices paymentServices, StoreContext context, IConfiguration config, ILogger<PaymentController> logger) : BaseApiController
{
    [Authorize]
    [HttpPost]
    ...
    private async Task HandlePaymentIntentFailed(PaymentIntent intent)
    {
        ...
        order.OrderStatus = OrderStatus.PaymnetFailed;
